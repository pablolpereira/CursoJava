...
public class ExercicioConceitoBasico_5 {
	public static void main(String[] args) {
		String ValorBase = JOptionPane.showInputDialog("Qual é o tamanho da base do Triangulo? em Metros");
		String ValorAltura = JOptionPane.showInputDialog("Qual é o tamanoa da altura do Triangulo? em Metros ");
